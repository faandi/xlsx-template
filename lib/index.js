...
module.exports = (function() {
    ...
    Workbook.prototype.generate = function(options) {
        ...
        options = options || {};
        options.compression = options.compression || 'STORE';
        options.mimeType = options.mimeType || 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet';

        if (!process.browser) {
          options.type = options.type || 'nodebuffer';
        } else {
          options.type = options.type || 'arraybuffer';
        }
